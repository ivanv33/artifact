...
- **Data (0)** — Raw facts: downloaded, scraped, imported
- **Info (1)** — Derivative of data, still close to truth: filtered, joined, tagged
- **Knowledge (2)** — Prediction models built from data/info: scripts that compute stats, find patterns
- **Wisdom (3)** — Conclusions using knowledge + info + data: actionable decisions
